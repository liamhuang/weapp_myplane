  ...
  constructor(){
    ...
    */
    ...
    /**
        ...
        @param g_GameObjectManager global objectManager
        @param x        The position on the X axis
        @param y        The position on the Y axis
        @param z        The z order of the element (elements in the background have a lower z value)
    */
    startupGameObject(/**GameObjectManager**/ g_GameObjectManager,/**Number*/ x, /**Number*/ y, /**Number*/ z)
    {
        this.zOrder = z;
        this.x = x;
        this.y = y;
    ...
    /**
        ...
        @param g_GameObjectManager global objectManager
    */
    shutdownGameObject( g_GameObjectManager)
    {
